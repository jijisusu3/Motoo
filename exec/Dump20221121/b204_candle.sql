...
CREATE TABLE `candle` (
  ...
  `date` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_candle_stock_7013df5a` (`stock_id`),
  CONSTRAINT `fk_candle_stock_7013df5a` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2022-11-21  0:25:15
