        ...
        <Slider {...settings}>
          <div className={classes.ctnbox}>
            <div className={classes.subbox}>
              ...
              <img className={classes.bounce} style={{margin:"auto", width:"90%"}} src={`${process.env.PUBLIC_URL}/login/sub1.svg`} alt="" />
          ...
          <div className={classes.ctnbox}>
            <div className={classes.subbox}>
              ...
              <img className={classes.bounce} style={{margin:"auto", width:"90%"}} src={`${process.env.PUBLIC_URL}/login/sub2.svg`} alt="" />
          ...
          <div className={classes.ctnbox}>
            <div className={classes.subbox}>
              ...
              <img className={classes.bounce} style={{margin:"auto", width:"90%"}} src={`${process.env.PUBLIC_URL}/login/sub3.svg`} alt="" />
            </div>
          </div>
        </Slider>

        <div>
          <button className={classes.kakao} onClick={kakaoLoginClick}><img src={`${process.env.PUBLIC_URL}/login/kakao.svg`} alt="" /></button>
        </div>
      </div>
    </div>
  );
