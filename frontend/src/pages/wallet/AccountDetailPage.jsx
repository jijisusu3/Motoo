      ...
      return (
        <>
          ...
          <div className={classes.settingBox}>
            <div className={classes.txts} style={{marginBottom: '5px'}} onClick={editOpen}>계좌명 수정</div>
            <hr />
            <div className={classes.txts} style={{marginTop: '5px'}} onClick={handleDeleteModalOpen}>계좌 삭제</div>
          </div>
        </>
      );
    }
          ...
          <Box className={classes.deletebox} sx={style}>
            ...
            <div className={classes.graybox}>
              ...
              <span style={{ marginLeft:"15px"}}>
                ...
                계좌를 삭제하면 <br></br> 해당 계좌의 주식, 자산들이 같이 삭제되어요!
              </span>
            </div>
